...
RSpec.describe TracksController do
  ...
  it 'has no nested method definitions' do
    result = RuboCop::CLI.new.run(['--only', 'Lint/NestedMethodDefinition', 'app/controllers/tracks_controller.rb'])
  ...
  describe 'DELETE #destroy' do
    ...
    it 'errors on mismatched album and track ids' do
      album_two = create(:album)

      expect { delete :destroy, params: { id: track, album_id: album_two } }.to raise_error ActiveRecord::RecordNotFound
    end
  end
end
